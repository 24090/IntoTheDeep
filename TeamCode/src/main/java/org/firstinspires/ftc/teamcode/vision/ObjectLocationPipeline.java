...
public class ObjectLocationPipeline extends OpenCvPipeline {
    ...
    public ObjectLocationPipeline(Camera.Colors color, Telemetry telemetry) {
        this.reprojection_matrix = Camera.getReprojectionMatrix();
...
//        output = new Mat();
        ...
        Imgproc.dilate(color_mask, color_mask, empty_mat, new Point(-1, -1), 9);
        ...
        if (keypoints.size().area() != 0) {
            ...
            // multiplication = (intrinsics * [ R_1 | R_2 | T ])^-1
            for (int i = 0; i < points.rows(); i++) {
                ...
                // [x, y, 1] = (intrinsics * [ R_1 | R_2 | T ])^-1 * [u, v, 1] * s
