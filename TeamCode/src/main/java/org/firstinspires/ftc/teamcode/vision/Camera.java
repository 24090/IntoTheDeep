...
public class Camera {
	...
	public static void init() {
		...
		pm.put(0, 0,  9.600476e+02); pm.put(0, 1, -1.837638e+02); pm.put(0, 2,  2.681114e+02);
		pm.put(1, 0,  0.000000e+00); pm.put(1, 1,  5.653888e+02); pm.put(1, 2, -1.396533e+04);
		pm.put(2, 0,  0.000000e+00); pm.put(2, 1, -6.427876e-01); pm.put(2, 2, -8.287017e+00);

		rm.put(0, 0,  1.041615e-03); rm.put(0, 1,  1.292433e-04); rm.put(0, 2, -1.841019e-01);
		rm.put(1, 0,  0.000000e+00); rm.put(1, 1,  6.065686e-04); rm.put(1, 2, -1.022193e+00);
		rm.put(2, 0, -0.000000e+00); rm.put(2, 1, -4.704887e-05); rm.put(2, 2, -4.138366e-02);
