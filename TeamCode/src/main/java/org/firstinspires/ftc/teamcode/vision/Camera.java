...
public class Camera {
	...
	public static void init() {
		...
		pm.put(0, 0,  9.600476e+02); pm.put(0, 1, -1.837638e+02); pm.put(0, 2,  2.232363e+02);
		pm.put(1, 0,  0.000000e+00); pm.put(1, 1,  5.653888e+02); pm.put(1, 2, -1.417919e+04);
		pm.put(2, 0,  0.000000e+00); pm.put(2, 1, -6.427876e-01); pm.put(2, 2, -8.118245e+00);

		rm.put(0, 0,  1.041615e-03); rm.put(0, 1,  1.242970e-04); rm.put(0, 2, -1.884526e-01);
		rm.put(1, 0,  0.000000e+00); rm.put(1, 1,  5.923921e-04); rm.put(1, 2, -1.034662e+00);
		rm.put(2, 0, -0.000000e+00); rm.put(2, 1, -4.690451e-05); rm.put(2, 2, -4.125668e-02);
