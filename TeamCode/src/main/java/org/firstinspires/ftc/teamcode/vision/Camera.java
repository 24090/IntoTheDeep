...
public class Camera {
	...
	public static void init() {
		...
		pm.put(0, 0,  9.600476e+02); pm.put(0, 1, -2.190011e+02); pm.put(0, 2,  9.806004e+02);
		pm.put(1, 0,  0.000000e+00); pm.put(1, 1,  4.156337e+02); pm.put(1, 2, -1.456039e+04);
		pm.put(2, 0,  0.000000e+00); pm.put(2, 1, -7.660444e-01); pm.put(2, 2, -5.469059e+00);

		rm.put(0, 0,  1.041615e-03); rm.put(0, 1,  1.511889e-04); rm.put(0, 2, -2.157521e-01);
		rm.put(1, 0,  0.000000e+00); rm.put(1, 1,  4.073170e-04); rm.put(1, 2, -1.084409e+00);
		rm.put(2, 0, -0.000000e+00); rm.put(2, 1, -5.705240e-05); rm.put(2, 2, -3.095499e-02);
